...
public partial class MainForm : Form
{
    ...
    private bool _objectDetectorAvailable;
    ...
    private void MainForm_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            // Set up form
            Text = _demoMode ? "Object Detection - Demo Mode (No Object Detection)" : "Object Detection - Mediapipe";
    ...
    private void ProcessFrame(Mat frame)
    {
        try
        {
            ...
            {
                DetectionResultItem detection = result.Detections[objectIndex];
                ...
                {
                    float confidence = detection.Categories[0].Score;
                    string categoryName = detection.Categories[0].CategoryName ?? "Unknown";

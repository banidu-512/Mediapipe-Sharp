...
public static class FaceMeshVisualizer
{
    ...
    private static readonly int[][] FaceMeshConnections = new[]
    {
        // Lips
        ...
        new[] { 95, 78 }, new[] { 78, 191 }, new[] { 191, 80 }, new[] { 80, 81 }, new[] { 81, 82 }, new[] { 82, 13 },
        new[] { 13, 312 },
        new[] { 312, 311 }, new[] { 311, 310 }, new[] { 310, 415 }, new[] { 415, 308 },

        // Left eye
        new[] { 33, 7 }, new[] { 7, 163 }, new[] { 163, 144 }, new[] { 144, 145 }, new[] { 145, 153 },
        new[] { 153, 154 },
        new[] { 154, 155 }, new[] { 155, 133 }, new[] { 133, 173 }, new[] { 173, 157 }, new[] { 157, 158 },
        new[] { 158, 159 },
        new[] { 159, 160 }, new[] { 160, 161 }, new[] { 161, 246 }, new[] { 246, 33 },

        // Right eye
        new[] { 362, 398 }, new[] { 398, 384 }, new[] { 384, 385 }, new[] { 385, 386 }, new[] { 386, 387 },
        new[] { 387, 388 },
        new[] { 388, 466 }, new[] { 466, 263 }, new[] { 263, 249 }, new[] { 249, 390 }, new[] { 390, 373 },
        new[] { 373, 374 },
        new[] { 374, 380 }, new[] { 380, 381 }, new[] { 381, 382 }, new[] { 382, 362 },

        // Left eyebrow
        new[] { 46, 53 }, new[] { 53, 52 }, new[] { 52, 65 }, new[] { 65, 55 }, new[] { 55, 70 }, new[] { 70, 63 },
        new[] { 63, 105 },
        new[] { 105, 66 }, new[] { 66, 107 }, new[] { 107, 55 }, new[] { 55, 65 }, new[] { 65, 52 }, new[] { 52, 53 },

        // Right eyebrow
        new[] { 276, 283 }, new[] { 283, 282 }, new[] { 282, 295 }, new[] { 295, 285 }, new[] { 285, 300 },
        new[] { 300, 293 }, new[] { 293, 334 },
        new[] { 334, 293 }, new[] { 293, 300 }, new[] { 300, 285 }, new[] { 285, 295 }, new[] { 295, 282 },
        new[] { 282, 283 },

        // Face oval
        new[] { 10, 338 }, new[] { 338, 297 }, new[] { 297, 332 }, new[] { 332, 284 }, new[] { 284, 251 },
        new[] { 251, 389 },
        new[] { 389, 356 }, new[] { 356, 454 }, new[] { 454, 323 }, new[] { 323, 361 }, new[] { 361, 340 },
        new[] { 340, 346 },
        new[] { 346, 347 }, new[] { 347, 348 }, new[] { 348, 349 }, new[] { 349, 350 }, new[] { 350, 451 },
        new[] { 451, 452 }, new[] { 452, 453 },
        new[] { 453, 464 }, new[] { 464, 435 }, new[] { 435, 410 }, new[] { 410, 287 }, new[] { 287, 273 },
        new[] { 273, 335 }, new[] { 335, 406 },
        new[] { 406, 313 }, new[] { 313, 18 }, new[] { 18, 83 }, new[] { 83, 182 }, new[] { 182, 106 },
        new[] { 106, 43 }, new[] { 43, 57 }, new[] { 57, 186 },
        new[] { 186, 92 }, new[] { 92, 165 }, new[] { 165, 167 }, new[] { 167, 164 }, new[] { 164, 393 },
        new[] { 393, 391 }, new[] { 391, 322 }, new[] { 322, 410 },
        new[] { 410, 287 }, new[] { 287, 273 }, new[] { 273, 335 }, new[] { 335, 321 }, new[] { 321, 308 },
        new[] { 308, 324 }, new[] { 324, 318 }, new[] { 318, 402 },
        new[] { 402, 317 }, new[] { 317, 14 }, new[] { 14, 87 }, new[] { 87, 178 }, new[] { 178, 88 }, new[] { 88, 95 },
        new[] { 95, 78 }, new[] { 78, 191 },
        new[] { 191, 80 }, new[] { 80, 81 }, new[] { 81, 82 }, new[] { 82, 13 }, new[] { 13, 312 }, new[] { 312, 311 },
        new[] { 311, 310 }, new[] { 310, 415 }, new[] { 415, 308 }
    };
        ...
        int connectionThickness = 1)
    {
        ...
        Scalar connColor =
            connectionColor ?? new Scalar(0, 0, 255); // Changed to Blue for better visibility (was Yellow)
        ...
        foreach (NormalizedLandmarks faceLandmarks in result.FaceLandmarks)
        {
    ...
    {
        Console.WriteLine(
            $"[DrawConnections] Drawing {FaceMeshConnections.Length} connections with thickness {thickness}");
        int drawnConnections = 0;
        int skippedConnections = 0;
        int invalidConnections = 0;

        foreach (int[] connection in FaceMeshConnections)
            if (connection.Length == 2 &&
                connection[0] < faceLandmarks.landmarks.Count &&
                connection[1] < faceLandmarks.landmarks.Count)
            {
                NormalizedLandmark startLandmark = faceLandmarks.landmarks[connection[0]];
                NormalizedLandmark endLandmark = faceLandmarks.landmarks[connection[1]];

...
public partial class MainForm : Form
{
    ...
    private bool _imageSegmenterAvailable;
    ...
    private bool IsValidModelFile(string modelPath)
    {
        try
        {
            ...
            {
                Console.WriteLine(
                    $"[IsValidModelFile] File too small: {fileInfo.Length} bytes (expected at least 2MB)");
                return false;
            }
    ...
    private void MainForm_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            // Set up form
            Text = _demoMode ? "Image Segmentation - Demo Mode (No Segmentation)" : "Image Segmentation - Mediapipe";
    ...
    private void ProcessFrame(Mat frame)
    {
        try
        {
            ...
            ImageSegmenterResult result = _imageSegmenter.SegmentForVideo(image, _frameTimestamp);

...
A minimalistic real-time image segmentation application using MediaPipe and OpenCV. This app performs live image
segmentation on webcam feed, displaying segmentation masks overlaid on the original video.
...
1. **Download Model**:
    - Download selfie segmentation model
      from [MediaPipe Image Segmentation](https://developers.google.com/mediapipe/solutions/vision/image_segmenter)
...
This application follows the same license as the parent MediaPipe-Sharp project. MediaPipe models have their own
licensing terms.

## Contributing

Contributions are welcome! Please follow the existing code patterns and ensure compatibility with the overall project
structure.

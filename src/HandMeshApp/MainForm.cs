    ...
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                // Set up form
                this.Text = _demoMode ? "Hand Mesh Detection - Demo Mode (No Hand Detection)" : "Hand Mesh Detection - Mediapipe";
            ...
            try
            {
                ...
                if (result.HandLandmarks != null && result.HandLandmarks.Count > 0)
                {
                    ...
                    for (int handIndex = 0; handIndex < result.HandLandmarks.Count; handIndex++)
                    {
                        ...
                        Console.WriteLine($"[ProcessFrame]   Visible landmarks (vis > 0.3): {visibleCount}/{handLandmarks.landmarks.Count}");
                    }
                }
                else
                {
